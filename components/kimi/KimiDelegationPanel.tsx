...
import KimiDelegationCard from './KimiDelegationCard';
import type { KimiDelegation } from '../../lib/kimi/kimi.types';

interface KimiDelegationPanelProps {
...
export default function KimiDelegationPanel({
  sessionId,
  delegations,
  onDelegate,
}: KimiDelegationPanelProps) {
