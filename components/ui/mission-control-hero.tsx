...
const AGENTS = [
  ...
  { name: "Sentinel", icon: Activity },
  { name: "AI Core", icon: Bot },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            >
              Mission Control<br />
              <span className="bg-gradient-to-br from-white via-white to-[#00d4ff] bg-clip-text text-transparent">
                Operations
              </span><br />
              Center
            </h1>
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Command and control your AI agent squad with precision. Real-time monitoring,
              task orchestration, and intelligent automation at your fingertips.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">System Efficiency</span>
                    <span className="text-white font-medium">99.7%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[99.7%] rounded-full bg-gradient-to-r from-cyan-400 to-blue-500" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <StatItem value="6" label="Agents" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="24/7" label="Active" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="Real-time" label="Sync" />
                </div>
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Active Agent Squad</h3>
              <div
              ...
              >
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4">
                  {[...AGENTS, ...AGENTS, ...AGENTS].map((agent, i) => (
                    ...
                    >
                      <agent.icon className="h-6 w-6 text-white fill-current" />
