/**
 * Kimi Portal Anton — GitHub API Route
 * POST /api/kimi-anton/github
 */

import { createBranch, openPR, listBranches } from '../../../../lib/kimi-anton/kimi.github';
...
export async function POST(request: Request) {
  try {
    ...
    console.error('[Kimi-Anton GitHub] Error:', error);
    return Response.json(
